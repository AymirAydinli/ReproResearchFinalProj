...
```  
According to the table above, average points scored was `r params$pts`, average number of rebounds grabbed was `r params$pts`, average number of assist distributed was `r params$ast`.
